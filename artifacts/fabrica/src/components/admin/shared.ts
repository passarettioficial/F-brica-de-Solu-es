...
export const ALL_DELIVERABLES: Array<{ phase: number; phaseName: string; key: string; label: string }> = [
  ...
  { phase: 5, phaseName: "PLANO DE IMPLEMENTAÇÃO", key: "MILESTONES", label: "Plano de Milestones" },
  { phase: 5, phaseName: "PLANO DE IMPLEMENTAÇÃO", key: "SPRINT_1", label: "Sprint 1 Detalhado" },
  { phase: 5, phaseName: "PLANO DE IMPLEMENTAÇÃO", key: "ESTRUTURA_PASTAS", label: "Estrutura do Projeto" },
  { phase: 5, phaseName: "PLANO DE IMPLEMENTAÇÃO", key: "README", label: "README Completo" },
  { phase: 5, phaseName: "PLANO DE IMPLEMENTAÇÃO", key: "GUIA_CONTRIBUICAO", label: "CONTRIBUTING.md" },
  { phase: 5, phaseName: "PLANO DE IMPLEMENTAÇÃO", key: "TECH_DEBT_LOG", label: "Log de Débito Técnico" },
  { phase: 5, phaseName: "PLANO DE IMPLEMENTAÇÃO", key: "DEFINITION_OF_DONE", label: "Definition of Done" },
  { phase: 6, phaseName: "PLANO DE TESTES", key: "PLANO_TESTES", label: "Plano de Testes" },
  { phase: 6, phaseName: "PLANO DE TESTES", key: "CASOS_TESTE_CRITICOS", label: "20 Casos de Teste Críticos" },
  { phase: 6, phaseName: "PLANO DE TESTES", key: "CHECKLIST_QA", label: "Checklist de QA" },
  { phase: 6, phaseName: "PLANO DE TESTES", key: "SCRIPT_USER_TEST", label: "Script de Teste com Usuários" },
  { phase: 6, phaseName: "PLANO DE TESTES", key: "RELATORIO_PERFORMANCE", label: "Benchmarks de Performance" },
  { phase: 6, phaseName: "PLANO DE TESTES", key: "BUGS_PREVENCAO", label: "Top 10 Bugs a Prevenir" },
  { phase: 6, phaseName: "PLANO DE TESTES", key: "OBSERVABILIDADE", label: "Plano de Observabilidade" },
  { phase: 7, phaseName: "PLANO DE DEPLOY", key: "RUNBOOK_DEPLOY", label: "Runbook de Deploy" },
  { phase: 7, phaseName: "PLANO DE DEPLOY", key: "GTM", label: "Plano Go-to-Market" },
  { phase: 7, phaseName: "PLANO DE DEPLOY", key: "LAUNCH_CHECKLIST", label: "Launch Checklist" },
  { phase: 7, phaseName: "PLANO DE DEPLOY", key: "METRICAS_POS_LAUNCH", label: "Dashboard Pós-Lançamento" },
  { phase: 7, phaseName: "PLANO DE DEPLOY", key: "PLANO_CRESCIMENTO_90_DIAS", label: "Plano de Crescimento 90 Dias" },
  { phase: 7, phaseName: "PLANO DE DEPLOY", key: "PITCH_INVESTIDORES", label: "Narrativa para Investidores" },
  { phase: 7, phaseName: "PLANO DE DEPLOY", key: "SLA_SUPORTE", label: "SLA & Plano de Suporte" },
];
