            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              {[
                ...
                <div key={right} className="flex items-start gap-2">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#b8461e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 mt-0.5">
