      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <div className="topbar">
          <div className="flex items-center gap-2 text-sm" style={{ color: "var(--text-tertiary)" }}>
            ...
            <span>/</span>
            <span style={{ color: "var(--text-primary)" }}>Atendimento</span>
          </div>
          <a
            href={whatsappUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-white text-xs font-medium px-3 py-1.5 rounded-lg transition-colors"
        ...
        <main className="flex-1 overflow-y-auto px-8 py-8 max-w-4xl w-full mx-auto space-y-12">
        {/* Hero */}
